...
int main(int argc, char **argv) {
  ...
  const y2024_bot3::CurrentLimits *current_limits =
      ...
      [falcons, modules,
       &can_position_sender](ctre::phoenix::StatusCode status) {
        ...
        const SwerveModule::ModuleGearRatios gear_ratios{
            .rotation = y2024_bot3::constants::Values::kRotationModuleRatio,
            .translation =
                y2024_bot3::constants::Values::kTranslationModuleRatio()};
  ...
  DrivetrainWriter drivetrain_writer(
      ...
      y2024_bot3::constants::Values::kDrivetrainWriterPriority, 12);

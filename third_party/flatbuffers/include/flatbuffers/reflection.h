...
inline bool IsScalar(reflection::BaseType t) {
  return t >= reflection::BaseType::UType && t <= reflection::BaseType::Double;
}
inline bool IsInteger(reflection::BaseType t) {
  return t >= reflection::BaseType::UType && t <= reflection::BaseType::ULong;
}
inline bool IsFloat(reflection::BaseType t) {
  return t == reflection::BaseType::Float || t == reflection::BaseType::Double;
}
inline bool IsLong(reflection::BaseType t) {
  return t == reflection::BaseType::Long || t == reflection::BaseType::ULong;
}
...
inline size_t GetTypeSize(reflection::BaseType base_type) {
  ...
  static_assert(sizeof(sizes) / sizeof(size_t) == static_cast<size_t>(reflection::BaseType::MaxBaseType) + 1,
                "Size of sizes[] array does not match the count of BaseType "
                "enum values.");
  return sizes[static_cast<size_t>(base_type)];
}
...
inline const String *GetFieldS(const Table &table,
  ...
  FLATBUFFERS_ASSERT(field.type()->base_type() == reflection::BaseType::String);
...
Vector<T> *GetFieldV(const Table &table, const reflection::Field &field) {
  FLATBUFFERS_ASSERT(field.type()->base_type() == reflection::BaseType::Vector &&
...
inline Table *GetFieldT(const Table &table, const reflection::Field &field) {
  FLATBUFFERS_ASSERT(field.type()->base_type() == reflection::BaseType::Obj ||

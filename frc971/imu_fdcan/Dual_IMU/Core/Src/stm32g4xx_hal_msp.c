...
void HAL_SPI_MspInit(SPI_HandleTypeDef *hspi) {
  ...
  if (hspi->Instance == SPI1) {
    ...
    PA7     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = SCK_TDK_ST_Pin | MISO_TDK_Pin | MOSI_TDK_ST_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    PB15     ------> SPI2_MOSI
    */
    GPIO_InitStruct.Pin = SCK_UNO_Pin | MISO_UNO_Pin | MOSI_UNO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    PC12     ------> SPI3_MOSI
    */
    GPIO_InitStruct.Pin = SCK_DUE_Pin | MISO_DUE_Pin | MOSI_DUE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef *huart) {
  if (huart->Instance == USART1) {
    ...
    PC5     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOC, T_VCP_TX_Pin | T_VCP_RX_Pin);
